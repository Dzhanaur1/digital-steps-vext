            ...
            <div className="col-xl-8">
              <div className="courses-content">
                ...
                <p className="text-para-1 mt-30">
                  Курс "Основы алгоритмизации" предназначен для детей, которые
                  хотят научиться решать задачи с использованием базовых
                  алгоритмических конструкций. В течение курса дети познакомятся
                  с основами логики, последовательности действий и построения
                  простых алгоритмов.
                </p>
